...
import static io.meeds.content.utils.NewsUtils.NewsObjectType.ARTICLE;
import static io.meeds.content.utils.NewsUtils.NewsObjectType.LATEST_DRAFT;
import static io.meeds.content.utils.NewsUtils.NewsUpdateType.CONTENT_AND_TITLE;
import static io.meeds.content.utils.NewsUtils.NewsUpdateType.PAGE_REFERENCE;
import static io.meeds.content.utils.NewsUtils.NewsUpdateType.POSTING_AND_PUBLISHING;
...
import io.meeds.content.model.ArticleTarget;
import io.meeds.content.model.ContentPublishEvent;
import io.meeds.content.model.News;
import io.meeds.content.model.NewsDraftObject;
import io.meeds.content.model.NewsLatestDraftObject;
import io.meeds.content.model.NewsPageObject;
import io.meeds.content.model.NewsPageVersionObject;
import io.meeds.content.model.filter.NewsFilter;
import io.meeds.content.notification.plugin.MentionInNewsNotificationPlugin;
import io.meeds.content.notification.plugin.PostNewsNotificationPlugin;
import io.meeds.content.notification.plugin.PublishNewsNotificationPlugin;
import io.meeds.content.notification.utils.NotificationConstants;
import io.meeds.content.notification.utils.NotificationUtils;
import io.meeds.content.plugin.ArticlePageAttachmentPlugin;
import io.meeds.content.search.NewsESSearchResult;
import io.meeds.content.search.NewsIndexingServiceConnector;
import io.meeds.content.search.NewsSearchConnector;
import io.meeds.content.utils.NewsUtils;
import io.meeds.content.utils.NewsUtils.NewsObjectType;
