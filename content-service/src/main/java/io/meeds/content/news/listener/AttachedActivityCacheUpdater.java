...
import static io.meeds.content.news.utils.NewsUtils.SCHEDULE_NEWS;
import static io.meeds.content.news.utils.NewsUtils.SHARE_NEWS;
import static io.meeds.content.news.utils.NewsUtils.UNSCHEDULE_NEWS;
...
public class AttachedActivityCacheUpdater extends Listener<String, News> {
  ...
  @PostConstruct
  public void init() {
    if (activityStorage instanceof CachedActivityStorage instance) {
      this.cachedActivityStorage = instance;
    }
