...
public class NewsActivityListener extends ActivityListenerPlugin {
  ...
  /**
   * Type of the activity comment generated by the kudos addon when a kudos is
   * sent on an activity or on one of its comments
   */
  ...
  public void saveComment(ActivityLifeCycleEvent event) {
    ...
    if (activity != null && activity.getTemplateParams() != null && activity.getTemplateParams().containsKey(NEWS_ID)) {
      org.exoplatform.services.security.Identity currentIdentity = ConversationState.getCurrent().getIdentity();
      // A kudos sent on the article, or on one of its comments, is collected as
      // a kudos reaction on that article and not as a comment on it
