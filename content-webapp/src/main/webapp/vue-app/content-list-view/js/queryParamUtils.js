...
// Extracted out of news/components/NewsApp.vue's copy-pasted equivalent so
// it can actually be reused instead of being re-implemented per app.
...
export function updateQueryParam(paramName, paramValue) {
  const url = paramValue !== null && typeof paramValue !== 'undefined' && paramValue !== ''
